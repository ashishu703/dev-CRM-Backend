-- Fix monthly_targets assignee_id/assigner_id types (project user IDs are UUID)
-- This table was introduced recently; safest repair is drop+recreate (keeps schema consistent).
